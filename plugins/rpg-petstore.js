...
const sections = [
   {
	title: "Buy A Pet",
	rows: [
	    {title: "Kucing 🐈", rowId: ".petshop cat", description: "Adopsi Kucing"},
	    {title: "Guguk 🐕", rowId: ".petshop dog", description: "Adopsi Guguk"},
	    {title: "Horse 🐎", rowId: ".petshop horse", description: "Adopsi Horse"},
	    {title: "Fox 🦊", rowId: ".petshop fox", description: "Adopsi Fox"},
	    {title: "Robo 🤖", rowId: ".petshop robo", description: "Buy A Robo"},
	]
    },{
	title: "Special Pet",
	rows: [
	{title: "lion", rowId: ".petshop lion", description: "Adopsi lion"},
    {title: "rhinoceros", rowId: ".petshop rhinoceros", description: "Adopsi rhinoceros"},
    {title: "dragon", rowId: ".petshop dragon", description: "Adopsi dragon"},
    {title: "centaur", rowId: ".petshop centaur", description: "Adopsi centaur"},
    {title: "kyubi", rowId: ".petshop kyubi", description: "Adopsi kyubi"},
    {title: "griffin", rowId: ".petshop griffin", description: "Adopsi griffin"},
    {title: "phonix", rowId: ".petshop phonix", description: "Adopsi phonix"},
    {title: "wolf", rowId: ".petshop wolf", description: "Adopsi wolf"}
	]
    },
]

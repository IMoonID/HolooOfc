...
${usedPrefix}${command} legendary`.trim()
  ...
  return conn.sendButton(m.chat,'*––––『 Leaderboard 』––––*', wrong, 'https://telegra.ph/file/883eb0e2889fc99326b43.jpg', [
[`Kembali ke menu`, `${usedPrefix}menu`],
[`My Inventory`, `${usedPrefix}inv`]
], m, {asLocation: false})
...
`.trim()
  return conn.sendButton(m.chat, `*–『 Global Leaderboard 』–*`, text, 'https://telegra.ph/file/0d874ded3a87e50d90584.jpg', [
